...
$(function () {
    ...
    $('.navL_M_sj > li:first-child, .navL_M_sj > li:nth-of-type(2)').hover(function () {
...
$(function () {
    ...
    // 오버 효과
    $(".nav_sj .navL_sj .navL_M_sj li, header .logo_1_sj, .sns_sj a, header .spMenu_btn_sj ul").hover(function () {
    ...
    // 제목에 마우스 오버 했을 때
    $("header .sns_sj ul li").hover(function () {
